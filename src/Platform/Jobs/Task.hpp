// Abstract unit of work for TaskQueue; Execute runs on a worker thread, Finalize on the main
// thread.
#pragma once
#include <cstdint>
#include <string_view>
...
enum class TaskStatus : uint8_t { Pending, Running, Completed, Failed };
